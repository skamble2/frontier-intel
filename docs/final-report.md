...
What the system found, how it was validated, and what is still open. It is
written for the two audiences it serves — an investment team and an engineering
team — and it is deliberately honest about the shape of the signal, including
where there is less of it than the headline numbers suggest.

Every figure below is reproducible from the committed database, and every event
named carries a verbatim quote and a source link in the system's own output.
...
evidence for it, in four parts: how extraction quality was measured, how
hallucination was controlled, how the scoring was validated, and what stands in
for ground truth when none exists.
