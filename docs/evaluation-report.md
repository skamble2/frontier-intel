...
1471 content documents fetched; 372 survived filtering (25.3%), yielding 954 events (2.56 per surviving document). 415 register document(s) (identity-evidence pages) are excluded from every bar — they are fetched to prove who someone is, not to yield insights.
...
largest gap gbm_sklearn +0.122 — MEMORISING: held-out accuracy is not evidence of generalisation.

### Learning curve

![Learning curve](figures/f11_learning_curve.png)

last step 160->320 pairs moved accuracy +0.002; plateaued — more labels will NOT help; the features are the limit.
