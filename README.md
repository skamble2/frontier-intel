...
| File | What it covers |
|---|---|
| [docs/final-report.md](docs/final-report.md) | **What the system found**, then how it was validated — six insights, the honest negatives, the full evaluation, and future scope |
| [docs/architecture.md](docs/architecture.md) | The stack and why · model selection per task · fallback strategies · design notes for every module |
