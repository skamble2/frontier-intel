...
re-observe affiliations -> cluster -> features -> score (per rubric, skipped
for a rubric with too few judge labels) -> evaluation report -> positions ->
digest -> alerts -> validation battery."""
